    ...
    <div className="flex flex-col items-center text-center max-w-7xl px-2 py-6 mt-8 md:mt-[12rem]">
      ...
      <div className="w-full flex flex-wrap justify-evenly gap-4 pl-0 lg:pl-4 mt-12">
        <div className="group relative w-full lg:w-[32%] h-[360px] lg:h-[440px]">
          <Image loading='lazy'  src="/assets/earrings.svg" alt="earrings" width={1000} height={1000} className="w-full h-full object-cover rounded-lg" />
        ...
        <div className="group relative w-full lg:w-[32%] h-[360px] lg:h-[440px]">
          <Image loading='lazy'  src="/assets/Anklets.svg" alt="earrings" width={500} height={500} className="w-full h-full object-cover rounded-lg" />
          <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-50 rounded-lg transition-opacity duration-300"></div>
        </div>
        <div className="group relative w-full lg:w-[32%] h-[360px] lg:h-[440px]">
          <Image loading='lazy'  src="/assets/Necklace.svg" alt="earrings" width={500} height={500} className="w-full h-full object-cover rounded-lg" />
          <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-50 rounded-lg transition-opacity duration-300"></div>
        </div>
        <div className="group relative w-full lg:w-[32%] h-[360px] lg:h-[440px]">
          <Image loading='lazy'  src="/assets/Bracelet.svg" alt="earrings" width={500} height={500} className="w-full h-full object-cover rounded-lg" />
          <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-50 rounded-lg transition-opacity duration-300"></div>
        </div>
        <div className="group relative w-full lg:w-[32%] h-[360px] lg:h-[440px]">
          <Image loading='lazy'  src="/assets/Rings.svg" alt="earrings" width={500} height={500} className="w-full h-full object-cover rounded-lg" />
          <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-50 rounded-lg transition-opacity duration-300"></div>
        </div>
      </div>
    </div>
