...
const Hero = () => {
  return (
    <div className="flex lg:flex-row flex-col lg:justify-evenly justify-center items-center mt-8 md:mt-20 md:px-12 px-8 py-6">
      <h1 className="px-4 lg:text-[6rem] text-[3.2rem] text-center  lg:w-[340px] font-serif mb-[5rem] lg:mb-0">Timeless Beauty,</h1>
      ...
      <h1 className="lg:text-[6rem] text-[3.2rem] text-center lg:w-[340px] font-serif mt-[5rem] lg:mt-0">Infinite Steeze.</h1>
    </div>
  );
};
