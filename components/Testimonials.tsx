  ...
  return (
    <div className="max-w-7xl flex flex-col items-center gap-4 md:px-12 px-0 py-8 mt-[14rem] md:mt-24 lg:mt-[15rem] relative">
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <p className="max-w-[75%] text-black text-[0.8rem]">
          We like the smiles that our customers send us when they recieve their
          items
        </p>
      </div>
      <div className="flex flex-col flex-wrap items-center justify-center w-full lg:w-[75%] h-[400px] lg:h-[400px] mt-8 relative">
        ...
        <Image
          ...
          width={500}
          height={500}
          className=" lg:w-[150px] w-[75px] h-[75px] lg:h-[150px] object-cover rounded-full"
        />
        <a href="https://www.instagram.com/stories/highlights/17967760721116713/">
        ...
        <Image
          ...
          width={500}
          height={500}
          className=" lg:w-[50px] w-[40px] h-[40px] lg:h-[50px] object-cover rounded-full absolute lg:bottom-[10rem] bottom-[12rem] left-[4rem] lg:left-[5rem]"
        />
      </div>
    </div>
  );
